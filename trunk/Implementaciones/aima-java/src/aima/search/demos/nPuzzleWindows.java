...
public class nPuzzleWindows extends JPanel implements KeyListener,
    ...
    // Constructor Generar con tama�o del Puzzle como parametro
    public nPuzzleWindows() {
        ...
        display_secuencias.setText("Entre las grandes cosas que podemos hacer y las peque�as que no hacemos el peligro esta en ni hacer ninguno de lo que pensabamos hacer por temor al fracaso del cual nunca estuvimos seguros");
        ...
        b_secuencias.setToolTipText("Juega el puzzle resuelto por el algoritmo");
        ...
        // Armamos el panel donde se insertara el tama�o de N
        JPsetN = new JPanel();
        ...
        b_evaluarPI.addActionListener(this);
        ...
        b_evaluarAstar.addActionListener(this);
    ...
    private void crear_botones_numericos(int tamanho) {
        ...
        botones_numericos[tamanho * tamanho - 1] = new JButton(String.valueOf(" "));
        botones_numericos[tamanho * tamanho - 1].setToolTipText(String.valueOf(" "));
    ...
    private void crear_botones_principales() {
        ...
        b_memoria.setToolTipText("Carga el tablero con estado inicial memorizado");
        ...
        b_evaluarPI.setToolTipText("Resuelve el Puzzle por metodo de Busqueda de Profundidad Iterativa");
        ...
        b_evaluarAstar.setToolTipText("Resuelve el Puzzle por el metodo de A* con numeor de piezas mal colocadas");
    ...
    private class ManejadorEventoBotones extends MouseAdapter implements
        ...
        public void actionPerformed(ActionEvent evento) {
            ...
            if (evento.getSource() == b_evaluarAstar);// Aqui debe llamar al menu de ayuda
                ...
                try {
                    ...
                    if ((tamanho < 3) || (tamanho > 10)) {
                        String salida = "El tama�o debe estar comprendido entre 3 y 10";
    ...
    public void actionPerformed(ActionEvent event) {
        String cadena = event.getActionCommand().trim();
