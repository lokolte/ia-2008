...
public class QapNsga_main {
  ...
  public static void main(String [] args) throws 
    ...
    fileHandler_ = new FileHandler("NSGA/QAP/QAP-NSGA.log"); 
    ...
    population.printVariablesToFile("NSGA/QAP/VAR");
    logger_.info("Objectives values have been writen to file FUN");
    population.printObjectivesToFile("NSGA/QAP/FUN");
