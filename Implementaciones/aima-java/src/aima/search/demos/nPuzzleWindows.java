...
public class nPuzzleWindows extends JPanel implements KeyListener,
	...
	public nPuzzleWindows() {
		...
		display_secuencias
				.setText("Entre las grandes cosas que podemos hacer y las peque�as que no hacemos el peligro esta en ni hacer ninguno de lo que pensabamos hacer por temor al fracaso del cual nunca estuvimos seguros");
