...
public class VrptwNsga_main {
  ...
  public static void main(String [] args) throws 
    ...
    String problemName = "src/files/vrptw/c101.txt";
    ...
    population.printVariablesToFile("NSGA/VRPTW/VAR"); 
    logger_.info("Objectives values have been writen to file FUN");
    population.printObjectivesToFile("NSGA/VRPTW/FUN");
