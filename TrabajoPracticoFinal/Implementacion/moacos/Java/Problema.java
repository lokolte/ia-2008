...
public class Problem
{
	...
	protected int size;
	protected abstract void cargar_estado(RefObject<String> file);
	public Problem(RefObject<String> file)
	{
		int i;
...
//C++ TO JAVA CONVERTER TODO TASK: The memory management function 'malloc' has no equivalent in Java:
	...
	public abstract double funcion_obj_1(RefObject<Solucion> sol);
	public abstract double funcion_obj_2(RefObject<Solucion> sol);
...
public class TSP extends Problem
{
	...
	public TSP(RefObject<String> file)
	{
		super(file);
		int i;
//C++ TO JAVA CONVERTER TODO TASK: The memory management function 'malloc' has no equivalent in Java:
...
//C++ TO JAVA CONVERTER TODO TASK: The memory management function 'malloc' has no equivalent in Java:
	...
	public double funcion_obj_1(RefObject<Solucion> sol)
	{
		int i;
		double suma =0;
		for(i =0;i<sol.argvalue.getSize()-1;i++)
			suma+=matrizAdy[sol.argvalue.get(i)][sol.argvalue.get(i+1)];
		suma+=matrizAdy[sol.argvalue.get(sol.argvalue.getSize()-1)][0];
		return suma;
	}
	public double funcion_obj_2(RefObject<Solucion> sol)
	{
		...
		double suma =0;
		for(i =0;i<sol.argvalue.getSize()-1;i++)
			suma+=matrizAdy2[sol.argvalue.get(i)][sol.argvalue.get(i+1)];
		suma+=matrizAdy2[sol.argvalue.get(sol.argvalue.getSize()-1)][0];
		return suma;
	}
